...
-- ===== 20260620110000_per_curriculum_reminders：提醒按课程(MMin 2/3)分发 =====
...
-- 补位「广播版」：补位请求覆盖全部课程(MMin 2 & 7)的缺口；
--   p_curriculum 现在只用于筛选「通知/邮件的收件人」(周六发 MMin 2 志愿者、周日发 MMin 3 志愿者)。
...
-- ===== 20260703100000_indonesian_messages.sql =====
...
-- ===== 20260704100000_obs_open_access.sql =====
...
-- === 20260705100000_obs_feedback.sql ===
